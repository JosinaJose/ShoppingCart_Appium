...
public static boolean checkIfServerIsRunnning(int port) {
	...
	public void startServer() {
		//path to server: C:\Users\karth\AppData\Roaming\npm\node_modules\appium\build\lib\main.js
		 service = new AppiumServiceBuilder().withAppiumJS(new File("c:\\Users\\Josina\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
	...
	public AndroidDriver<AndroidElement> setup() throws Exception {
		...
		Thread.sleep(1000);
		startEmulator();
		logger = Logger.getLogger("Mobile_ShoppingApp");// Project Name
		...
		File fs = new File(f, "97th Vintage_1_Apkpure.apk");
